...
def main():
    ...
    if training_args.do_train:
        ...
        column_names = datasets[data_args.eval_split].column_names
        features = datasets[data_args.eval_split].features
    ...
    if adapter_args.train_adapter:
        task_name = data_args.task_name or "ner"
    ...
    if training_args.do_eval:
        ...
        eval_dataset = datasets[data_args.eval_split]
