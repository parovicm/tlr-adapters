...
from transformers import BertModel, BertPreTrainedModel, ModelWithHeadsAdaptersMixin
...
class TransformerForBiaffineParsing(ModelWithHeadsAdaptersMixin, BertPreTrainedModel):
    """
